          ...
          <div className="rounded-[12px] border border-zinc-850 bg-[#0d0d0e] overflow-hidden flex flex-col min-h-[105px] shadow-sm select-text mt-auto">
            ...
            <div className="p-3 font-mono text-[9px] leading-relaxed overflow-y-auto flex-1 select-text flex flex-col gap-0.5">
              {terminalLog.split("\n").map((line, i) => {
                ...
                if (line.includes("[SUCCESS]") || line.toLowerCase().includes("success") || line.toLowerCase().includes("listening") || line.toLowerCase().includes("resolved") || line.includes("✓")) {
                ...
                } else if (line.includes("$") || line.includes("curl") || line.toLowerCase().includes("resolving")) {
